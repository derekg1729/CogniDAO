...
class TestCogniMemoryClient:
    ...
    @patch("legacy_logseq.memory.memory_tool.CogniMemoryClient")
    def test_memory_tool_integration(self, mock_memory_client, test_directories):
        ...
        client_instance.query.assert_called_once_with(
            query_text="tool test", n_results=1, include_archived=False, filter_tags=None
        )
...
This is a test page with frontmatter."""
    ...
    def test_write_page_with_frontmatter(self, test_directories):
        ...
        try:
            ...
            filepath = client.write_page(test_file, test_content, frontmatter=frontmatter_data)
        ...
        try:
            ...
            with patch(
                ...
                total_indexed = client.index_from_logseq(
                    logseq_dir=test_logseq_dir, embed_model="mock"
                )
            ...
            with patch.object(client.storage.chroma.collection, "query") as mock_query:
                ...
                assert (
                    "#thought" in results.blocks[0].tags or "#broadcast" in results.blocks[0].tags
                )
    ...
    def test_index_from_logseq_with_tag_filter(self, test_directories):
        ...
        try:
            ...
            with patch(
                ...
                total_indexed = client.index_from_logseq(
                    logseq_dir=test_logseq_dir, tag_filter="#thought", embed_model="mock"
                )
            ...
            with patch.object(client.storage.chroma.collection, "query") as mock_query:
                ...
                mock_query.return_value = {
                    ...
                    "documents": [
                        [
                            "Block with #thought tag only",
                            "Block with both #thought and #broadcast tags",
                        ]
                    ],
                    "metadatas": [
                        [
