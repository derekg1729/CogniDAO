...
from legacy_logseq.openai_handler import create_thread, thread_completion
...
class TestThreadedHandler(unittest.TestCase):
    ...
    def test_create_thread(self):
        ...
        thread_id, assistant_id = create_thread(
            client=self.mock_client, instructions="Test instructions", model="gpt-4"
        )
        ...
        self.mock_client.beta.assistants.create.assert_called_once_with(
            name="ThreadedCompletion", instructions="Test instructions", model="gpt-4"
        )
    ...
    def test_thread_completion_polling(self):
        ...
        self.mock_client.beta.threads.runs.retrieve.side_effect = [run_in_progress, run_completed]
    ...
    def test_thread_completion_no_assistant_message(self):
        ...
        expected_response = {"choices": [{"message": {"content": ""}}]}
        self.assertEqual(response, expected_response)
