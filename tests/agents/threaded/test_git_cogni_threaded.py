...
class TestGitCogniThreaded(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.pr_data = {
            ...
            "branch_info": {"source_branch": "feature", "target_branch": "main", "success": True},
        }
    ...
    def test_review_pr_creates_thread(
        ...
        mock_create_thread.assert_called_once_with(self.agent.openai_client, "Combined context")
    ...
    @patch("legacy_logseq.cogni_agents.git_cogni.git_cogni.thread_completion")
    @patch("legacy_logseq.cogni_agents.git_cogni.git_cogni.extract_content")
    def test_review_pr_uses_thread_for_commits(
        self, mock_extract, mock_thread_completion, mock_create_thread
    ):
    ...
    @patch("legacy_logseq.cogni_agents.git_cogni.git_cogni.thread_completion")
    @patch("legacy_logseq.cogni_agents.git_cogni.git_cogni.extract_content")
    def test_review_pr_uses_thread_for_verdict(
        self, mock_extract, mock_thread_completion, mock_create_thread
    ):
    ...
    @patch("legacy_logseq.cogni_agents.git_cogni.git_cogni.thread_completion")
    @patch("legacy_logseq.cogni_agents.git_cogni.git_cogni.extract_content")
    def test_review_pr_multiple_commits(
        self, mock_extract, mock_thread_completion, mock_create_thread
    ):
