...
from infra_core.flows.rituals.ritual_of_presence import ritual_of_presence_flow
...
def test_prefect_parameter_handling_behavior():
    ...
    print(f"Function parameter annotations: {getattr(ritual_of_presence_flow.fn, '__annotations__', {})}")
    ...
    try:
        ...
        try:
            result = ritual_of_presence_flow._validate_parameters_and_update_defaults({"custom_prompt": None})
