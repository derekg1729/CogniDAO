...
class TestGitCogniE2E(unittest.TestCase):
    ...
    def _mock_pr_info(self):
        ...
        return {"owner": "derekg1729", "repo": "CogniDAO", "number": 2, "success": True}
            ...
            "commits": [
                {
                    ...
                    "files": [
                        {
                            "filename": "legacy_logseq/cogni_agents/base.py",
                            "status": "added",
                            "additions": 120,
                            "deletions": 0,
                            "changes": 120,
                ...
                },
                {
                    ...
                    "files": [
                        {
                            "filename": "legacy_logseq/openai_handler.py",
                            "status": "added",
                            "additions": 80,
                            "deletions": 0,
                            "changes": 80,
                ...
                },
                {
                    ...
                    "files": [
                        {
                            "filename": "legacy_logseq/flows/rituals/ritual_of_presence.py",
                            "status": "added",
                            "additions": 150,
                            "deletions": 0,
                            "changes": 150,
                ...
                },
                {
                    ...
                    "files": [
                        {
                            "filename": "legacy_logseq/cogni_spirit/guides/marketing-spirit.md",
                            "status": "modified",
                            "additions": 1,
                            "deletions": 2,
                            "changes": 3,
...
"""
        ...
        mock_extract_content.side_effect = lambda response: response["choices"][0]["message"][
            "content"
        ]
