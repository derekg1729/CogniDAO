...
# from legacy_logseq.memory.client import CogniMemoryClient
...
class TestFutureBroadcastIntegration:
    ...
    def test_context_generation(self, test_memory_client):
        ...
        # with patch("legacy_logseq.cogni_agents.broadcast.BroadcastCogni") as mock_broadcast:
    ...
    def test_memory_weighted_prompt_construction(self, test_memory_client):
        ...
        #     from legacy_logseq.memory.schema import MemoryBlock, MemoryQueryResult
        #
        ...
        #     from legacy_logseq.cogni_agents.broadcast import BroadcastCogni
    ...
    def test_end_to_end_agent_memory_flow(self, test_memory_client):
        ...
        pytest.skip(
            "PLACEHOLDER: Complete memory-agent integration will be implemented in the future"
        )
