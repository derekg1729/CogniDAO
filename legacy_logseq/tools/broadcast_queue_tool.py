...
def add_to_broadcast_queue(
    ...
    scheduled_time: Annotated[
        Optional[str],
        "ISO format datetime for scheduled broadcast (leave empty for 'as soon as possible')",
    ] = None,
) -> str:
    """
...
"""
        ...
        error_result = {"status": "error", "message": f"Failed to add to broadcast queue: {str(e)}"}
