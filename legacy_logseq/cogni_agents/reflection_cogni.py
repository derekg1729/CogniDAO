...
class ReflectionCogniAgent(CogniAgent):
    ...
    def __init__(
        ...
        memory_adapter: CogniLangchainMemoryAdapter,
    ...
    def act(self, prepared_input: Dict[str, Any]) -> Dict[str, Any]:
        ...
        previous_thought = prepared_input.get(
            "previous_thought", "[Previous thought not available]"
        )
        ...
        try:
            ...
            system_message = (
                ...
                else {"role": "system", "content": "You are a reflective AI assistant."}
            )
