...
from legacy_logseq.cogni_agents.base import BaseCogniMemory
...
class CoreCogniAgent(CogniAgent):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            spirit_path=Path("legacy_logseq/cogni_spirit/spirits/cogni-core-spirit.md"),
    ...
    def prepare_input(self, prompt: Optional[str] = None) -> Dict[str, Any]:
        ...
        return {"prompt": prompt, "temperature": 0.8}
