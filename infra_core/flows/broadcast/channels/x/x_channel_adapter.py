...
from infra_core.flows.broadcast.channels.x.x_channel import XChannel
...
class XChannelAdapter(BroadcastChannel):
    ...
    def __init__(self, credentials_path: Optional[str] = None, simulation_mode: bool = True):
        ...
        self.x_channel = XChannel(credentials_path=credentials_path, simulation_mode=simulation_mode)
