...
# from infra_core.memory.memory_mcp_server import app, startup_event, shutdown_event
...
class TestMemoryMCPServer:
    ...
    async def test_websocket_connection(self):
        ...
        # with patch("infra_core.memory.memory_mcp_server.get_memory_client"):
        #     process = await asyncio.create_subprocess_exec(
        #         "uvicorn", "infra_core.memory.memory_mcp_server:app",
