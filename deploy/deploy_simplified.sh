#!/bin/bash
# Simplified deployment script following best practices
# Uses Docker contexts and environment-specific override files
# 
# Usage:
#   ./deploy_simplified.sh local           # Local development
#   ./deploy_simplified.sh preview         # Deploy to preview server  
#   ./deploy_simplified.sh prod            # Deploy to production server
#   ./deploy_simplified.sh cleanup preview # Clean up preview server
#   ./deploy_simplified.sh cleanup prod    # Clean up production server
