...
class DocMetadata(BaseModel):
    ...
    audience: Optional[str] = Field(
        None, 
        description="Intended audience for the document (e.g., 'developers', 'users')"
    )
    section: Optional[str] = Field(
        None, 
        description="Section or category the document belongs to"
    )
    ...
    completed: bool = Field(
        False, 
        description="Whether the document is complete/finalized"
    )
