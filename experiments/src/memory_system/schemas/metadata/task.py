...
class TaskMetadata(BaseModel):
    ...
    action_items: Optional[List[str]] = Field(
        ...
        description="Specific steps required to complete the task"
    )
    test_criteria: Optional[List[str]] = Field(
        default_factory=list, 
        description="Criteria to verify the task is implemented correctly"
    )
    success_criteria: Optional[List[str]] = Field(
        default_factory=list, 
        description="Criteria to verify the task meets its objectives"
    )
    ...
    current_status: Optional[str] = Field(
        None, 
        description="Detailed description of current implementation state"
    )
